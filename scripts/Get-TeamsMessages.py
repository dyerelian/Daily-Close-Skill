...
Used by the `close-day` skill to sweep the Teams messages Dan exchanged today, so it can
...
the skill can fall back to asking Dan to paste the relevant chats.
...
DEFAULT_SRC = (
    r"C:\Users\E724101\AppData\Local\Packages\MSTeams_8wekyb3d8bbwe\LocalCache"
    r"\Microsoft\MSTeams\EBWebView\WV2Profile_tfw\IndexedDB"
    ...
    try:
        ...
        if not messages:
            warning = ("No Teams messages found for this day in the local cache "
                       "(the cache may be stale, or there were none). Ask Dan to paste any relevant chats.")
